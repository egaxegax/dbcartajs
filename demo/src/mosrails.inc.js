...
function init() {
  ...
  dw.extend(dw.mopt, {
    ...
    's3_3': inst({labelcolor: dw.mopt['r3'].fg, anchor: ['end']}),
    ...
    's9_1': inst({labelcolor: dw.mopt['r9'].fg, anchor: ['start', 'hanging']}),
    ...
    's10': inst_l({labelcolor: dw.mopt['r10'].fg,  anchor: ['end', 'hanging']}),
